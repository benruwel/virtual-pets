...
public class DatabaseRule extends ExternalResource {
    ...
    protected void before() {
        DB.sql2o = new Sql2o("jdbc:postgresql://localhost:51718/virtual_pets_test", "postgres", "Benmwangi1999");  //Those with linux or windows use two strings for username and password
    }
